...
- 海景/船/鱼/码头/鱼箱跟 Runtime 自绘同一套更饱和的卡通皮肤，不是外部立绘包。港口有分层渐变、水面噪点、软阴影、视差卷动、灯笼闪烁、市集灯带/烟火。
- 湾鳍 idle 摆尾眨眼、S 线游动、水下折射色，弱点准星脉冲可读。
- 抛竿有短蓄力条和甩竿轨迹预览；翻扑落地有冻结帧和扬尘。命中/入箱/卖出跳字取自 `StyleCallout`；粒子、线闪、金币雨取自 `HitJuice`。
- WebAudio **多音色包络占位音效**，标明 ≠ 真机。
