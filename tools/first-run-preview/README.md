...
- 海景/船/鱼/码头/鱼箱跟 Runtime 自绘同一套休闲钓鱼皮肤。港口有分层渐变、手绘噪波、边缘光、近景桩网灯笼、视差与灯火。
- 湾鳍有轮廓线、鳞片高光、眼部表演（虹膜/高光/眨眼）和水下折射。
- 教学抛竿仍可自动落到甜区；**教完后的自由局必须再点「甩出」**，早/晚是普通命中，准时才精彩倍率。
- 翻扑落地冻结加长、扬尘加大，静帧能读出砸拍。命中/入箱/卖出跳字取自 `StyleCallout`。
