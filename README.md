...
- Cocos Creator 3.8 TypeScript 灰盒：海边鱼市、出海扑腾、教学关、五岛、22种鱼与3个首领
- 每日订单、周挑战、无尽潮、工具分支、鱼类熟练度、精彩度与新鲜度循环
- 微信、本地Web、CrazyGames和Android平台适配；广告/IAP为待配置的商业化骨架
- 本地/云存档、`submitScore`云校验好友榜、Google Play票据验证、埋点与发布门禁
...
新玩家默认进入练潮码头教学，依次完成抛竿、弱点击破、捡起和入箱；完成后才开放泡沫湾。教学首售约11金、鱼竿2级90金，买不起升级时主按钮仍引导再次出海。

阶段2加入本地每日订单、统一种子的周挑战和Boss后无尽潮。每日奖励仅为金币或外观碎片；周挑战标记付费/广告加成局为不可上榜；无尽潮每3分钟一轮，可随时撤离，失败只丢当前轮未入箱收益。当前存档schema为v3，启动时会迁移v1及缺字段旧档。

主线为海边鱼市与五岛捕鱼：先拽船上砸晕卖掉；教完后可在码头捞木头、加宽码头。基础内容含22种鱼与3个Boss。程序化低多边形美术、短滑/逃水/空中砸窗口和分层合成音效共同强化捕获手感；外观不提供周挑战数值权益。

资源登记见 `THIRD_PARTY_ASSETS.md`，商店实拍规格见 `docs/STORE_ASSET_CHECKLIST.md`。
