...
| 模块 | 行为 |
| --- | --- |
| `HarborStage` | 港口/结算 3D 浮站：近/中/远三层水面、浮筒木甲板、鱼箱、简易市集棚、远景半沉楼影与浮木、停泊小船。侧光塑形。UI 仍 2D。 |
...
| --- | --- | --- |
| `01_harbor_wide.png` 港湾远景 | 刚进港口，不要点出海 | 透视近/中/远海 + 矮波；左侧浮站木甲板/市集棚；远处半沉楼影与浮木；日落侧光；2D 主橙 CTA。**下半屏**主操作，上半是海。 |
...
- 水面不是一条平色带。
- 远处是淹没天际：半沉楼影、水线、浮木，读得出洪水浮岛，不是灰码头。
- HUD 仍是 2D，主橙 CTA 在下。
