...
- **C 首局经济闭环（本刀）**：教学路径入箱预算 ≤60s（潮汐钟 50→60，兜底 55s→40s，40+10+10≤60）；卖出可读（`卖出 +11金 · 11/90`，不堆特效）；缺口「还差 79 · 再出海能补」+ 进度条；买不起升级写「还差79」且不抢主 CTA。**11/90 标价不动。** 不做 E、不刷代理视觉 tip、`:8766` 不算过关、未约验。
