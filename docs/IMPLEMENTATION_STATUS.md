...
- **W1 世界壳（本刀）**：港改成潮退浮站。`HarborStage` / `ProcGeom` 远层半沉楼影 + 浮木，中层浮筒甲板 / 箱 / 市集棚；`ArtRecipe` 2D 回退同一套。`RuntimeHome` 标题「潮退浮站 · 浮岛小站」，订单板 / 浮台升级只开「修建中」。主橙仍是出海 / 开始教学 / 再出海。经济 **11/90 冻结**。规格见 `docs/FLOOD_ISLAND_FISHING_SPEC.md`。下一刀 W2：活站（真订单文案 / 漂物点一下 / 浮台换皮），仍不深经济。
