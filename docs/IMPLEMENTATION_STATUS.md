...
- 第一局体验代理与 `tools/first-run-preview/shots/` **不是** Cocos 实机证据，更 **不是** Creator 3D 证据。本轮代理加港口分层渐变/噪点/软阴影/视差、湾鳍表情与折射、抛竿蓄力轨迹、落地冻结+扬尘，以及多音色 WebAudio 占位；仍只能报代理分，不合 main。
