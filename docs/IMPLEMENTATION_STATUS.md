...
- 第一局体验代理与 `tools/first-run-preview/shots/` **不是** Cocos 实机证据，更 **不是** Creator 3D 证据。本轮对症：岛/码头加体块、边缘光、手绘噪波与近景层；湾鳍加轮廓/高光/眼部；教学仍可自动甜区，**教完后自由局必须自己松手**（早/晚普通命中，准时才精彩倍率）；砸拍冻结加长、扬尘加大；占位音按事件分层。仍只能报代理分，不合 main。
