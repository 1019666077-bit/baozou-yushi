...
| --- | --- | --- | --- |
| 1 | `01_harbor_wide.png` 港湾远景 | 刚进港口，不要点出海 | 斜俯视一眼 **海+浮台+人+远景**：透视近/中/远海 + 矮波；中央浮站木板格/市集棚；站姿渔夫与订单板；远处半沉楼影一圈与浮木（读得出洪水浮岛，不是灰码头）；日落侧光；标题「潮退浮站」；下方 2D 主橙「开始教学」。**下半屏**主 CTA，上半是海。短滑/完美窗口这张还看不到。 |
